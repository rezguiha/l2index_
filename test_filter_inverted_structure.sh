...
python3 test_filter_inverted_structure.py -i ${INDEXED_PATH}  -s ${TEST_DIR_PATH}  > ${TEST_DIR_PATH}/stdout/out_filter_python.log 2> ${TEST_DIR_PATH}/stderr/err_filter_python.log &
