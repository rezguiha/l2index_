...
INDEXPATH=/home/mrim/rezguiha/work/repro_chap7_res/enwikIR_full_documents_indexed/indexed_collection
...
python evaluating_baseline_wikIR_without_training.py -c ${COLLPATH} -i $INDEXPATH -p ${RESULT_PLOT_PATH}plots -r ${RESULT_PLOT_PATH}results  -n "Evaluating_baseline_WikIR" > ${RESULT_PLOT_PATH}stdout/eval.log 2> ${RESULT_PLOT_PATH}stderr/eval.log &
